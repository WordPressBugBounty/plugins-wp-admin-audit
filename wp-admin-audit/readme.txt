...
Yes, WP Admin Audit has full translation and localization support via the "wp-admin-audit" text domain.
...
= Manual installation =
Manual installation requires downloading the WP Admin Audit plugin (from this listing) and uploading it to WordPress. The WordPress documentation has [a tutorial for that]https://wordpress.org/documentation/article/manage-plugins/#upload-via-wordpress-admin).
...
== Upgrade Notice ==
= 1.2.16 =
Fix for Fix Uncaught TypeError: array_keys(), New PHP minimum version 7.0, Prevent PHP warnings

= 1.2.15 =
Fix for PHP notice _load_textdomain_just_in_time, Tested with WP v6.8
