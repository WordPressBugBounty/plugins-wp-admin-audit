                        ...
                        <div class="wada-welcome-panel-column">
                            ...
                            if($nrPossibleExtensions):
                                ...
                                if($nrPossibleExtensions == 1){
                                    ...
                                    $extensionText = sprintf(__('Upgrade to <strong>%1$s</strong> to capture <strong>%2$s</strong> events (and for at least %3$d other plugins)', 'wp-admin-audit'), $upgradeEdition, $targetPlg, ($nrPossibleExtensions-1));
                                }
                                ?>
